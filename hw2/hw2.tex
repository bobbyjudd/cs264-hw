...
\section{}
\begin{enumerate}
    \item The sub functions after setting $X_1, ..., X_{[N/2]}$ would need to ensure that the cardinality is the opposite of $X_{[(N/2) + 1]}, ..., X_N$.  That is, if the caridinality of the first half is odd then the second half must even, or vice versa.  This will ensure an odd cardinality for the full OBDD.
